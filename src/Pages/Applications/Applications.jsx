            ...
            >
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-5xl font-bold">Worksheets</h1>
                        {/* <button className="btn btn-primary">Get Started</button> */}
                    </div>
                </div>
            </div>

            <h1 className='text-2xl text-center mb-6 font-bold text-green-500 mt-12'>Worksheets link</h1>
            <div className='grid lg:grid-cols-3'>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="justify-center">
                            <Link className=" justify-center" to='/englishworksheetlink'>
                                <div>
                                    <button className="btn text-black bg-green-400 hover:bg-green-500">See Details</button>
                                </div>
                            </Link>
